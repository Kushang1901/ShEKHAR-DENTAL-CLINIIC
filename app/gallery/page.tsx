...
import { ChevronRight, Calendar, ZoomIn, Star } from 'lucide-react';
      ...
      <section className="subpage-banner">
        <div className="container">
          <div className="animate-fade-in">
            ...
            <p>
              Witness our dedication to clinical precision, surgical achievements, and radiant patient smile transformations.
            </p>
