...
export const metadata: Metadata = {
  ...
  description:
    'SHEKHAR DENTAL AND ORTHODONTIC CENTRE (Shekhar Dental Clinic) in Sagarpur East, New Delhi. Led by Founder & Lead Dental Surgeon Dr. Prakash Thakur (Doctor Prakash Thakur). Specialized in Dental Implants, Braces & Aligners, Rotary Root Canal (RCT), Cosmetic Dentistry, and Sunday Free Consultations. Call 098702 94558.',
  keywords: [
